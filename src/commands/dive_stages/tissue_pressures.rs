pub mod tissue_pressure {
    ...
    pub fn calculate_tissue_pressure_nitrogen(compartment: usize, dive_model: DiveModel, dive_profile_model: DiveProfile, dive_step: DiveStep) -> f32 {
    ...
    pub fn calculate_tissue_pressure_helium(compartment: usize, dive_model: DiveModel, dive_profile_model: DiveProfile, dive_step: DiveStep) -> f32 {
    ...
    pub fn calculate_tissue_pressure_total(compartment: usize, dive_profile_model: DiveProfile) -> f32 {
