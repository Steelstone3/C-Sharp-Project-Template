pub mod a_b_values {
    ...
    pub fn calculate_a_value(compartment: usize, dive_model: DiveModel, dive_profile_model: DiveProfileModel) -> f32 {
    ...
    pub fn calculate_b_value(compartment: usize, dive_model: DiveModel, dive_profile_model: DiveProfileModel) -> f32 {
